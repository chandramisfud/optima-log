              ...
              {isLoading ? (
                ...
                activities.map((activity, index) => (
                  <tr key={index} className="table-row">
                    ...
                    <td className="table-cell">{activity.date}</td>
                    <td className="table-cell">{activity.email}</td>
                    <td className="table-cell">{activity.subject}</td>
...
export default withAuth(MandrillEmailPage);